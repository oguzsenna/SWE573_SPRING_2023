...
urlpatterns = [
    ...
    path("create_story", StoryCreateAPIView.as_view(), name= 'create-story'),
    ...
    path('profile/photo/<int:user_id>', UserPhotoView.as_view(), name='user_profile_photo'),
    ...
    path('delete/stories/<int:story_id>/', DeleteStoryView.as_view(), name='delete_story'),
